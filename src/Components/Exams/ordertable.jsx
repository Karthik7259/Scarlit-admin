...
//         `https://scarlit-backend.onrender.com/api/order/${editingOrder._id}`,
//         editingOrder
//       );
...
//                             {isEditing ? (
//                               <textarea
//                                 className="border border-gray-300 rounded px-2 py-1 w-full bg-gray-50 p-3 rounded-lg"
...
//                                 <option value="Processing" className="text-amber-400">Processing</option>
...
//                             ) : (
//                               <span className={`px-2 inline-flex text-xs leading-5 font-semibold rounded-full 
//                                 ${selectedOrder.status === 'Completed' ? 'bg-green-400 text-green-800' : 
//                                   selectedOrder.status === 'Processing' ? 'bg-yellow-100 text-yellow-800' : 
//                                   'bg-gray-100 text-gray-800'}`}>
//                                 {selectedOrder.status || "Pending"}
//                               </span>
...
//                                 value={editingOrder.storeComment || ""}
//                                 onChange={(e) => handleInputChange('storeComment', e.target.value)}
//                                 rows="3"
//                                 placeholder="Add store comments"
//                               />
//                             ) : (
//                               <div className="bg-gray-50 p-3 rounded-lg">
//                                 {selectedOrder.storeComment || "No store comments"}
